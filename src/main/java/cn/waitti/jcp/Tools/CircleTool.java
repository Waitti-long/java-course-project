...
public class CircleTool implements EnabledTool{
    ...
    public void startCircle(MouseEvent mouseEvent){
        x1= mouseEvent.getX();
        y1= mouseEvent.getY();
    ...
    public void endCircle(MouseEvent mouseEvent){
        x2= mouseEvent.getX();
        y2= mouseEvent.getY();
    ...
    public void activate() {
        pane.setOnMousePressed(this::startCircle);
        pane.setOnMouseReleased(this::endCircle);
    }
