...
public class EllipseTool implements EnabledTool {
    ...
    public void stratEllipse(MouseEvent mouseEvent) {
        x1 = mouseEvent.getX();
        y1 = mouseEvent.getY();
    ...
    public void endEllipse(MouseEvent mouseEvent) {
        x2 = mouseEvent.getX();
        y2 = mouseEvent.getY();
        width = x2 - x1;
        height = y2 - y1;
    ...
    public void activate() {
        pane.setOnMousePressed(this::stratEllipse);
        pane.setOnMouseDragged(null);
        pane.setOnMouseReleased(this::endEllipse);
    }
